...
const contactSchema = {
  ...
  "description": "Get in touch with Hikvision Dubai's support team for all your security camera needs. Professional assistance for CCTV installation, maintenance, and technical support available 24/7.",
  "url": "https://hikvisionuae.ae/Contact",
  "keywords": "Hikvision Dubai contact, CCTV support UAE, security camera installation Dubai, Hikvision technical support, CCTV maintenance UAE, security system help Dubai hikvision uae, hikvision dubai, hikvision middle east, hikvision distributor uae, hikvision supplier uae, hikvision authorized distributor in uae, hikvision support uae, hikvision dealer dubai",
  "mainEntity": {
    "@type": "Organization",
      ...
      <div className="bg-gradient-to-b from-gray-50 to-gray-100 min-h-screen py-12 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-center mb-12 transform hover:scale-105 transition-transform duration-300">
            ...
            <p className="text-xl text-gray-600 animate-slide-up">We're here to help with your security camera needs</p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-12">
            <div className="bg-white p-8 rounded-xl shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2 border-t-4 border-red-600">
              ...
              <h3 className="text-2xl font-bold text-gray-900 text-center mb-3">Phone Support</h3>
              <p className="text-lg text-gray-600 text-center hover:text-red-600 transition-colors">+971 50 989 3134</p>
            ...
            <div className="bg-white p-8 rounded-xl shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2 border-t-4 border-red-600">
              ...
              <h3 className="text-2xl font-bold text-gray-900 text-center mb-3">Email Support</h3>
              <p className="text-lg text-gray-600 text-center hover:text-red-600 transition-colors">sales@hikvisionuae.ae</p>
            ...
            <div className="bg-white p-8 rounded-xl shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2 border-t-4 border-red-600">
              ...
              <h3 className="text-2xl font-bold text-gray-900 text-center mb-3">Office Location</h3>
              <p className="text-lg text-gray-600 text-center hover:text-red-600 transition-colors">No. 12, Al khabaisi, Abu hail</p>
              <p className="text-gray-600 text-center">Dubai, United Arab Emirates</p>
            </div>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-7xl mx-auto">
            ...
            <div className="bg-white rounded-2xl shadow-xl p-10 hover:shadow-2xl transition-shadow duration-300 border border-gray-100 backdrop-blur-lg bg-opacity-95">
              ...
              <div className="w-full h-[600px] rounded-lg overflow-hidden shadow-lg transform transition-all duration-300 hover:scale-[1.02]">
                <iframe
                  src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3305.7152203640542!2d-118.2436689!3d34.0522342!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x80c2c75ddc27da13%3A0xe22fdf6f254608f4!2sLos%20Angeles%2C%20CA!5e0!3m2!1sen!2sus!4v1650000000000!5m2!1sen!2sus"
                  width="100%"
                  height="100%"
                  style={{ border: 0 }}
                  allowFullScreen=""
