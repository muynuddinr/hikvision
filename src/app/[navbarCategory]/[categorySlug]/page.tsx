...
const generateSchema = (category: Category | null, subcategories: SubCategory[], navbarCategory: string): SchemaData => {
    ...
    return {
        ...
        description: category?.description || `Explore Hikvision ${category?.name} solutions and products in UAE`,
        ...
        <>
            <script
                ...
                dangerouslySetInnerHTML={{
                    __html: JSON.stringify(generateSchema(category, subcategories, navbarCategory))
                }}
            />
                                            ...
                                            <div className="relative h-48 mb-6 bg-gradient-to-b from-red-50/50 to-transparent rounded-xl p-4">
                                                ...
                                                {subcategory.image ? (
                                                    ...
                                                    <div className="relative h-full w-full flex items-center justify-center">
                                                        <div className="text-2xl font-bold text-red-600/80">{subcategory.name}</div>
                                                    </div>
                                                )}
                                            </div>
